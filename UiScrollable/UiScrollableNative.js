...
import ScrollAnimator from './UiScrollAnimator';
import Scrollbar from './UiScrollbar';

import css from './UiScrollable.module.less';
...
class ScrollableBaseNative extends Component {
	...
	static propTypes = /** @lends moonstone/UiScrollableNative.ScrollableNative.prototype */ {
		/**
		 * Render function.
		 *
		 * @type {Function}
