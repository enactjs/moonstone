...
describe('DayPicker', () => {
	describe('#aria-label', () => {
		test('should use title, selected long string when day is single selected', () => {
			render(<DayPicker title="Day Picker" selected={0} />);
		...
		test('should use title, selected long string when day is multi selected', () => {
			render(<DayPicker title="Day Picker" selected={[0, 1]} />);
		...
		test('should be null when day is not selected', () => {
			render(<DayPicker title="Day Picker" />);
		...
		test('should use title, everyDayText when every day is selected', () => {
			render(<DayPicker title="Day Picker" everyDayText="every" selected={[0, 1, 2, 3, 4, 5, 6]} />);
		...
		test('should use title, everyWeekdayText when every weekday is selected', () => {
			render(<DayPicker title="Day Picker" everyWeekdayText="weekday" selected={[1, 2, 3, 4, 5]} />);
		...
		test('should use title, everyWeekendText when every weekend is selected', () => {
			render(<DayPicker title="Day Picker" everyWeekendText="weekend" selected={[0, 6]} />);
