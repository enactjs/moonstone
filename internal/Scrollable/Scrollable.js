 ...
 *
 * @module moonstone/internal/Scrollable
 * @exports constants
 * @exports Scrollable
...
class ScrollableBase extends Component {
	...
	static propTypes = /** @lends moonstone/internal/Scrollable.Scrollable.prototype */ {
		/**
		 * Render function.
		 *
		 * @type {Function}
		 ...
		 *
		 * `'both'` could be only used for[Scroller]{@link moonstone/internal/Scroller.Scroller}.
		 *
		 * Valid values are:
		 * * `'both'`,
		 * * `'horizontal'`, and
 ...
 * @class Scrollable
 * @memberof moonstone/internal/Scrollable
 * @extends moonstone/internal/Scrollable.ScrollableBase
 * @ui
 * @private
 */
