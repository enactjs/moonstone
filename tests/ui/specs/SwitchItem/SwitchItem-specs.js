...
describe('SwitchItem', function () {
	...
	describe('default', function () {
		...
		it('should have correct text', async function () {
			expect(await switchItem.valueText).toBe('Switch Item1');
		});
	...
	describe('default selected', function () {
		...
		it('should have correct text', async function () {
			expect(await switchItem.valueText).toBe('Switch Item selected');
		});
	...
	describe('inline', function () {
		...
		it('should have correct text', async function () {
			expect(await switchItem.valueText).toBe('Switch Item inline');
		});
	...
	describe('disabled', function () {
		...
		it('should have correct text', async function () {
			expect(await switchItem.valueText).toBe('Switch Item disabled');
		});
	...
	describe('inline disabled', function () {
		...
		it('should have correct text', async function () {
			expect(await switchItem.valueText).toBe('Switch Item inline disabled');
		});
