...
describe('ActivityPanels', function () {
	...
	describe('Transition', function () {
		...
		it('should navigate back to the Third panel from clicking on breadcrumb', async function () {
			await Page.waitTransitionEnd(5000, 'one', async () => {
				await Page.item1.click();
			}, []);
			await Page.waitTransitionEnd(5000, 'two', async () => {
				await Page.item5.click();
			}, []);
			await Page.waitTransitionEnd(5000, 'three', async () => {
				await Page.breadcrumbHeader.click();
			}, []);
			await Page.waitTransitionEnd(5000, 'four', async () => {
				await Page.item8.click();
			}, []);
			await Page.waitTransitionEnd(5000, 'five', async () => {
				await Page.button4.click();
			}, []);
			await Page.waitTransitionEnd(5000, 'six', async () => {
				await Page.breadcrumbHeader.click();
			}, []);
	...
	describe('Spotlight', function () {
		...
		describe('5way', function () {
			...
			it('should spot last focused item when transitioning back using back key', async function () {
				Page.spotlightDown();
				await Page.waitTransitionEnd(5000, 'panel open', async () => {
					await Page.spotlightSelect();
				}, []);
				expect(await Page.item5.isFocused()).to.be.true();
				await Page.waitTransitionEnd(5000, 'panel back', async () => {
					await Page.backKey();
				}, []);
