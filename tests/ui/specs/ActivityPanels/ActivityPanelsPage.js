...
class SpotlightMultiplePage extends Page {
	...
	get breadcrumbHeader () {
		return $('.Panels_Panels_breadcrumbHeader');
	}
	get closeButton () {
		return $('.Panels_ApplicationCloseButton_applicationCloseButton');
	}
	get panelTitle () {
		return $('.Panels_Header_title .enact_ui_Marquee_Marquee_text').getText();
	}
	get body () {
		return $('body');
	}
