...
class FormCheckboxItemInterface {
	...
	get isAfter () {
		return this.self.$(componentSelector({component: 'SlotItem', child: 'after'})).isExisting();
	}
	get isBefore () {
		return this.self.$(componentSelector({component: 'SlotItem', child: 'before'})).isExisting();
	}
	get isInline () {
