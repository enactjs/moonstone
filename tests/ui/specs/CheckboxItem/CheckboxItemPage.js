...
class CheckboxItemInterface {
	...
	get isChecked () { return browser.$(`#${this.id} .Checkbox_Checkbox_selected`).isExisting(); }
	get isAfter () { return browser.$(`#${this.id} .SlotItem_SlotItem_after`).isExisting(); }
	get isBefore () { return browser.$(`#${this.id} .SlotItem_SlotItem_before`).isExisting(); }
